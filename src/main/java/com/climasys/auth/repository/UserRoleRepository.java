...
public interface UserRoleRepository extends JpaRepository<UserRole, UserRoleId> {
       ...
       @Query("SELECT rm.roleId FROM RoleMaster rm WHERE rm.clinicId = :clinicId AND rm.roleName = 'Doctor'")
       Integer findRoleIdByClinicId(@Param("clinicId") String clinicId);
}
