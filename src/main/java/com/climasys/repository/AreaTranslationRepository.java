...
public interface AreaTranslationRepository extends JpaRepository<AreaTranslation, AreaTranslationId> {
    ...
    AreaTranslation findByAreaNameAndLanguageId(@Param("areaName") String areaName,
    ...
    @Query("SELECT at FROM AreaTranslation at WHERE at.id.cityId = :cityId AND at.id.stateId = :stateId AND at.id.languageId = :languageId")
    List<AreaTranslation> findByCityIdAndStateIdAndLanguageId(@Param("cityId") String cityId,
            @Param("stateId") String stateId, @Param("languageId") Integer languageId);

    @Query("SELECT at FROM AreaTranslation at WHERE at.id.cityId = :cityId AND at.id.stateId = :stateId")
    List<AreaTranslation> findByCityIdAndStateId(@Param("cityId") String cityId, @Param("stateId") String stateId);
}
