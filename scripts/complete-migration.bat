...
REM =====================================================
REM Climasys Complete Migration Script
REM SQL Server to PostgreSQL Migration
REM =====================================================
...
if exist "%CSV_DIR%" (
    ...
    cd /d "%MIGRATION_DIR%"
    python "%MIGRATION_DIR%\05_postgresql_import_script.py"
    if %errorlevel% equ 0 (
    ...
    echo [WARNING] 1. Run the queries from 04_sqlserver_extraction_queries.sql on your SQL Server
