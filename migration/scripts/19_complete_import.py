#!/usr/bin/env python3
"""
Complete Data Import Script for Climasys

This script imports all data in the correct dependency order
and handles schema mapping properly.
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('complete_import.log'),
...
class CompleteImporter:
    def __init__(self, postgres_config):
        """Initialize the complete importer."""
    ...
    def import_all_data(self, data_dir="extracted_data"):
        ...
        try:
            ...
            # Save import summary
            summary_file = os.path.join(data_dir, "complete_import_summary.json")
            with open(summary_file, 'w') as f:
                json.dump(import_summary, f, indent=2)
            
            logger.info(f"Complete import finished. Summary saved to {summary_file}")
...
def main():
    ...
    logger.info("Starting Complete PostgreSQL Data Import")
    logger.info("=" * 60)
    
    # Create importer instance
    importer = CompleteImporter(postgres_config)
    ...
    try:
        ...
        logger.info("Importing data in dependency order...")
        ...
        logger.info("Complete data import successful!")
