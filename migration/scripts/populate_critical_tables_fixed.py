#!/usr/bin/env python3
"""
Populate Critical Tables with Realistic Data - Fixed Column Names
This script populates the core tables using the correct column names from the actual schema.
"""
...
def populate_clinic_master(conn, data, num_clinics=5):
    """Populate clinic_master table with correct column names"""
    ...
    try:
        for i in range(num_clinics):
            ...
            cursor.execute("""
                ...
                (clinic_id, clinic_name, address, phone_number, email, is_active, created_on, modified_on,
                 "Clinic_Address", "CreatedBy_Name", "ModifiedBy_Name")
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                ON CONFLICT (clinic_id) DO NOTHING
            """, (clinic_id, clinic_name, address, phone_number, email, True, datetime.now(), datetime.now(),
...
def populate_doctor_master(conn, data, num_doctors=10):
    """Populate doctor_master table with correct column names"""
    ...
    try:
        for i in range(num_doctors):
            ...
            specialization = random.choice(data['specialties'])
            qualification = random.choice(['MD', 'MBBS', 'DO', 'PhD'])
            registration_no = f"MD{random.randint(100000, 999999)}"
            
            cursor.execute("""
                INSERT INTO climasys_dev.doctor_master 
                (doctor_id, first_name, last_name, email, phone, specialization, qualification, 
                 is_active, created_on, modified_on, "Speciality", "Registration_No",
                 "CreatedBy_Name", "ModifiedBy_Name")
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                ON CONFLICT (doctor_id) DO NOTHING
            """, (doctor_id, first_name, last_name, email, phone, specialization, qualification,
                  True, datetime.now(), datetime.now(), specialization, registration_no,
                  'System', 'System'))
...
def populate_user_master(conn, data, num_users=15):
    """Populate user_master table with correct column names"""
    ...
    try:
        ...
        for user_id, username, email, user_role, clinic_id in admin_users:
            cursor.execute("""
                INSERT INTO climasys_dev.user_master 
                (user_id, username, email, user_role, clinic_id, is_active, created_on, modified_on,
                 "First_Name", "Last_Name", "CreatedBy_Name", "ModifiedBy_Name")
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                ON CONFLICT (user_id) DO NOTHING
            """, (user_id, username, email, user_role, clinic_id, True, datetime.now(), datetime.now(),
        ...
        for i, (doctor_id, first_name, last_name) in enumerate(doctors):
            ...
            cursor.execute("""
                INSERT INTO climasys_dev.user_master 
                (user_id, username, email, user_role, clinic_id, doctor_id, is_active, created_on, modified_on,
                 "First_Name", "Last_Name", "CreatedBy_Name", "ModifiedBy_Name")
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                ON CONFLICT (user_id) DO NOTHING
            """, (user_id, username, email, 'DOCTOR', clinic_id, doctor_id, True, datetime.now(), datetime.now(),
                  first_name, last_name, 'System', 'System'))
...
def populate_patient_master(conn, data, num_patients=50):
    """Populate patient_master table with correct column names"""
    ...
    try:
        ...
        for i in range(num_patients):
            ...
            emergency_contact_name = f"{random.choice(data['first_names'])} {random.choice(data['last_names'])}"
            
            cursor.execute("""
                INSERT INTO climasys_dev.patient_master 
                (patient_id, first_name, last_name, email, phone, gender_id, blood_group_id,
                 date_of_birth, age, address, emergency_contact, emergency_contact_name, is_active, 
                 created_on, modified_on, "Address_1", "CreatedBy_Name", "ModifiedBy_Name")
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                ON CONFLICT (patient_id) DO NOTHING
            """, (patient_id, first_name, last_name, email, phone, gender_id, blood_group_id,
                  date_of_birth, age, address, emergency_contact, emergency_contact_name, True,
                  datetime.now(), datetime.now(), address, 'System', 'System'))
...
def populate_patient_visits(conn, num_visits=100):
    """Populate patient_visits table with correct column names"""
        ...
        for i in range(num_visits):
            ...
            cursor.execute("""
                ...
                (visit_id, patient_id, doctor_id, clinic_id, visit_date, visit_time, 
                 chief_complaint, diagnosis, treatment, created_on, modified_on,
                 "CreatedBy_Name", "ModifiedBy_Name")
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                ON CONFLICT (visit_id) DO NOTHING
            """, (visit_id, patient_id, doctor_id, clinic_id, visit_date, visit_time,
                  chief_complaint, diagnosis, treatment, datetime.now(), datetime.now(),
                  'System', 'System'))
...
def main():
    """Main function"""
    logger.info("🚀 Starting Critical Tables Population (Fixed Column Names)")
    logger.info("=" * 70)
